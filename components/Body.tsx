  ...
  return (
    <div>
        <section className="flex flex-col gap-3 justify-center items-center bg-black py-4">
            ...
            <section className="flex flex-col gap-3 justify-center items-center bg-black mt-20" >

             <Heading text="Selected Projects" />

             {projects.map((project, index) => (
                <ProjectCard key={index} text={project.text} image={project.image} link={project.link} />
             ))}
            </section>
        </section>
    </div>
